...
-- 1. Instalar extensión pgvector (requiere PostgreSQL 14+)
...
CREATE TABLE IF NOT EXISTS tenants (
    ...
    -- Precios personalizados (enterprise)
...
CREATE TABLE IF NOT EXISTS face_subjects (
    ...
    -- El embedding facial — 512 dims para ArcFace
    ...
    -- Un external_id es único por tenant
...
-- Índice HNSW para búsqueda aproximada de vecinos (ANN)
-- Necesario para escalar a millones de embeddings
...
-- 6. Admin users (panel de administración)
